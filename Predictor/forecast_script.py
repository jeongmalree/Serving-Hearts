...
data = pd.read_csv('C:/XAMPP/htdocs/Serving Hearts/Predictor/blood_inventory_handover.csv', parse_dates=['Month'], index_col='Month').asfreq('MS')
...
plt.legend()
plt.tight_layout()
plt.savefig('C:/XAMPP/htdocs/Serving Hearts/Predictor/graphs/blood_handover_forecast.png')
plt.close()
